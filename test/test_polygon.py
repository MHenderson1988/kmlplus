...
class TestPolygon(TestCase):
    ...
    def test_new_layer(self):
        ...
        test_coordinates_with_arc = ['22.23232 -3.232323 0', 'start=21.23211 -4.122121, end=22.054541 -4.1111, z=15, direction=clockwise']
        ...
        result_dd_arc = Polygon.create_polygon(test_coordinates_with_arc)
